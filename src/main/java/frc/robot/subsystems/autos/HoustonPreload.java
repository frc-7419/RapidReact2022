...
public class HoustonPreload extends ParallelCommandGroup {

    public HoustonPreload(DriveBaseSubsystem driveBaseSubsystem, GyroSubsystem gyroSubsystem, ShooterSubsystem shooterSubsystem, LimelightSubsystem limelightSubsystem, FeederSubsystem feederSubsystem, LoaderSubsystem loaderSubsystem, LEDSubsystem ledSubsystem, TurretSubsystem turretSubsystem) {
        addCommands(
            sequence(
        ...
        addCommands(new InstantCommand(driveBaseSubsystem::coast, driveBaseSubsystem));
