...
public class OneBallAuto extends SequentialCommandGroup {
    ...
    public OneBallAuto(OldDriveBaseSubsystem driveBaseSubsystem, GyroSubsystem gyroSubsystem, ShooterSubsystem shooterSubsystem, LimelightSubsystem limelightSubsystem, FeederSubsystem feederSubsystem, LoaderSubsystem loaderSubsystem) {
        addCommands(
