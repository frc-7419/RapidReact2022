package frc.robot.autonSelector;
...
public class AutonomousModeSelector {
    ...
    private Optional<AutonomousModeBase> mAutoMode = Optional.empty();
    ...
    private Optional<AutonomousModeBase> getAutoModeForParams(DesiredMode mode, StartingPosition position) {
        switch (mode) {
            case DO_NOTHING:
    ...
    public Optional<AutononousModeBase> getAutoMode() {
        return mAutoMode;
    }
}